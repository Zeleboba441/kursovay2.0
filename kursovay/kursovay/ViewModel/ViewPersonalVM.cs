...
{
    public class ViewPersonalVM : BaseVM
    {
        private List<Personal> presonals;
        ...
        public int SelectedIndex
        {
            ...
            {
                selectedIndex = value;
                Personals = SqlModel.GetInstance().SelectPersonalsRange((selectedIndex - 1) * ViewRowsCount, ViewRowsCount);
                Signal();
            }
        }
        ...
        private void InitPages()
        {
            ...
            int pageCount = (sqlModel.GetNumRows(typeof(Personal)) / ViewRowsCount) + 1;
