...
namespace kursovay.Model
{
    public class SqlModel
    {
        ...
        public List<Kab> SelectKabsRange(int skip, int count)
        {
            var kabs = new List<Kab>();
            var mySqlDB = MySqlDB.GetDB();
            string query = $"SELECT * FROM `kab` LIMIT {skip},{count}";
        ...
        public List<Vrach> SelectVrachsRange(int skip, int count)
        ...
        public List<Personal> SelectPersonalsRange(int skip, int count)
